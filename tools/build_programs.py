...
L = {
    ...
    "neckflex":  dict(name="Chin Tuck",                name_tr="Çeneyi İçeri Çekme",          kind="neckflex",  sides=[None],            base_reps=10, domain="Deep neck flexors",        domain_tr="Derin boyun kasları"),
...
PROGRAMS = {
    ...
    "boyun-agrisi": [
        ("neckflex",  "Chin tucks activate the deep neck flexors, the muscle group that is weak in almost every chronic neck-pain presentation.",
                      "Çeneyi içeri çekmek, kronik boyun ağrısının neredeyse tamamında zayıf olan derin boyun kaslarını çalıştırır.", 10),
